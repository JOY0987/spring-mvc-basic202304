...
@Repository("memory") // 스프링 빈 등록 : 객체의 생성의 제어권을 스프링에게 위임 (@Repository: 저장소 빈에 사용)
public class ScoreRepositoryImpl implements ScoreRepository { // Impl : 구현체가 한개일때 제목에 사용
