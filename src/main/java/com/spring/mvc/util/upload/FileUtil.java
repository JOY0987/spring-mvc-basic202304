...
public class FileUtil {
    ...
    public static String uploadFile(
        ...
        // ex) 어쩌고.png -> dfasfdjsiofwe-daskdjfl_어쩌고.png
        String newFileName = UUID.randomUUID() + "_" + file.getOriginalFilename();
            // 실무에서 pk에 auto increment 대신 랜덤 문자열 UUID.randomUUID()을 쓰는 경우가 많음.
        
        // 이 파일을 저장할 날짜별 폴더를 생성
        // D;/spring-prj/upload/2023/05/16/dfasfdjsiofwe-daskdjfl_어쩌고.png
        ...
        return fullPath.substring(rootPath.length()); // /부터 살려주기
    }
