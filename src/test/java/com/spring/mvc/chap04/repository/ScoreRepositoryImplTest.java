...
//            "그 학생의 국어 점수가 33점이고 이름이 춘식이어야 한다.")
//    void findOneTest() {
//        // given
//        int stuNum = 2;
//
//        // when
//        Score score = repositoty.findByStuNum(stuNum);
//
//        // then
...
//            "성적의 개수가 2개일 것이고, 다시 2번 학생을 조회했을 때 null 이 반환되어야 한다.")
//    void deleteTest() {
//        // given
//        int stuNum = 2;
//        // when
//        repositoty.deleteByStuNum(stuNum);
//        List<Score> scoreList = repositoty.findAll();
//        Score score = repositoty.findByStuNum(stuNum);
//        // then
...
//
//    @Test
//    @DisplayName("새로운 성적정보를 save를 통해 추가하면 목록의 개수가 4개여야 한다.")
//    void saveTest() {
//        // given
...
//        score.setEng(0);
//        // when
//        boolean flag = repositoty.save(score);
//        List<Score> scoreList = repositoty.findAll();
//        // then
